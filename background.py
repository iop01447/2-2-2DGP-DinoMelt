...
class TileBackground:
    ...
    def draw(self):
        ...
        self.tile_map.objects_draw(self.window_left, self.window_bottom)

    def draw_minimap(self):
        self.minimap_image.draw(self.canvas_width - (self.w * 0.5), self.canvas_height - (self.h * 0.5), self.w * 0.5, self.h * 0.5)
